...
## ===================================    
## 1. Предобработка данных - "Исследование надёжности заёмщиков — анализ банковских данных" <a id="project01"></a>  
...
## 2. Исследовательский анализ данных - "Продажа квартир в Санкт-Петербурге — анализ рынка недвижимости" <a id="project02"></a>  
...
## 3. Статистический анализ данных - "Определение выгодного тарифа для телеком компании" <a id="project03"></a>  
...
## 4. Сборный Проект №1 - "Изучение закономерностей, определяющих успешность игр" <a id="project04"></a>  
...
## 5. Сбор и хранение данных - "Исследование данных авиакомпании — проверить гипотезу о повышении спроса во время фестивалей" <a id="project05"></a>  
...
## 6. Анализ бизнес-показателей - "Оптимизация маркетинговых затрат в Яндекс.Афише" <a id="project06"></a>  
...
## 7. Принятие решений в бизнесе на основе данных - "Проверка гипотез по увеличению выручки в интернет-магазине — оценика результатов A/B теста" <a id="project07"></a>  
...
## 8. Как рассказать историю с помощью данных - "Исследования рынка общепита в Москве для принятия решения об открытии нового заведения" <a id="project08"></a>  
...
## 9. Сборный проект №2 - "Анализ пользовательского поведения в мобильном приложении" <a id="project09"></a>  
...
## 10. Автоматизация - "Создание дашборда по пользовательским событиям для агрегатора новостей" <a id="project10"></a>    
...
## 11. Прогнозы и предсказания - "Прогнозирование вероятности оттока пользователей для фитнес-центров" <a id="project11"></a>  
